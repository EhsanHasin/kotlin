...
object NewInferenceForIDEAnalysisComponent {
    ...
    fun setEnabled(project: Project, state: Boolean) {
        PropertiesComponent.getInstance(project).setValue(inferenceOption, state, false)
    }

    @JvmStatic
    fun isEnabled(project: Project): Boolean {
        return PropertiesComponent.getInstance(project).getBoolean(inferenceOption, false)
    }
}